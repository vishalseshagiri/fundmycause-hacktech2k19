...
def nearest_walmart(lat,long):
    api_str = 'https://maps.googleapis.com/maps/api/place/nearbysearch/json?location='+str(lat)+','+str(long)+'&radius=20000&name=walmartr&key=AIzaSyC2cBWP6AA79xwXmBRzEhvwoMWi9_SIsWA'
    try:
